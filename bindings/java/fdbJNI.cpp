...
bool getByteArrays(JNIEnv* jenv, jlong tPtr, jbyteArray keyBeginBytes, jbyteArray keyEndBytes, jbyteArray mapperBytes) {
...
JNIEXPORT jlong JNICALL Java_com_apple_foundationdb_FDBTransaction_Transaction_1getMappedRange(JNIEnv* jenv,
                                                                                               ...
                                                                                               jboolean reverse,
                                                                                               jint matchIndex) {
	uint8_t *barrBegin, *barrEnd, *barrMapper;
	if (!getByteArrays(jenv, tPtr, keyBeginBytes, keyEndBytes, mapperBytes)) {
		return 0;
	}
	FDBTransaction* tr = (FDBTransaction*)tPtr;
